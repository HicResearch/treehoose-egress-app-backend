    ...
    def __init__(
        ...
        AwsCustomResource(
            ...
            on_create=self.create(
                configuration_set_name, event_destination_name, destination_topic_arn
            ),
    ...
    def create(
        ...
        create_params = {
            ...
            "EventDestination": {
                ...
                "SnsDestination": {"TopicArn": destination_topic_arn},
            },
        ...
        return AwsSdkCall(
            ...
            physical_resource_id=PhysicalResourceId.of(
                f"SNS-{configuration_set_name}-destination"
            ),
        )
